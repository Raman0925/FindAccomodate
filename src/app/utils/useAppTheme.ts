...
type ThemeContextType = {
  themeScheme: ThemeContexts | ColorSchemeName;
...
export interface UseAppThemeValue {
...
export const useAppTheme = (): UseAppThemeValue => {
  ...
  const themeVariant: Theme = useMemo(
    () => themeContextToTheme(themeContext as ThemeContexts),
    [themeContext],
  );
  ...
  return {
    ...
    setThemeContextOverride,
    theme: themeVariant,
    themeContext: themeContext as ThemeContexts,
    themed,
  };
};
